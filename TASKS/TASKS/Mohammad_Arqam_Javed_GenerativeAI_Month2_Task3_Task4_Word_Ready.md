...
- [ ] Export to PDF
- [ ] Use file naming format: **Name_Domain_Month1** or **Name_Domain_Month2**
- [ ] Final Month 2 file name: **Mohammad_Arqam_Javed_GenerativeAI_Month2.pdf**
- [ ] Email PDF to **submissions.archtech@gmail.com**
- [ ] Upload LinkedIn post and mention **@Arch Technologies**
- [ ] Ensure submission is complete, clean, and professionally structured

---

## How to Submit (Step-by-Step)
1. Finalize the report in Word with:
	- Front page details (Full Name, Internship Domain, Email, Phone Number)
	- Project explanation + code section
	- Relevant screenshots of outputs
2. Save and export the report as PDF.
3. Rename exactly as:
	- **Mohammad_Arqam_Javed_GenerativeAI_Month2.pdf**
4. Send email to **submissions.archtech@gmail.com** with:
	- Subject: **Month 2 Submission - Mohammad Arqam Javed - Generative AI**
	- Attachment: final PDF report
	- Message body: short professional submission note
5. Post your work summary on LinkedIn and mention **@Arch Technologies**.
6. Recheck the PDF once before sending (structure, readability, screenshots, formatting).
